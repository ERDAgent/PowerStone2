...
const expectedCharacterCopy = [
  ['Falcon', 'A daring aerial adventurer and the guide’s default fighter.', 'Falcon returns to the hunt with a bold, mobile style and a taste for treasure.', ['all-rounder', 'aerial rushdown']],
  ['Wang-Tang', 'An energetic martial artist built around direct momentum.', 'Wang-Tang brings disciplined training and irrepressible confidence to the fray.', ['momentum brawler', 'rushdown']],
  ['Ryoma', 'A wandering swordsman with measured reach.', 'Ryoma’s traditional bearing contrasts with the chaos of transforming arenas.', ['poke specialist', 'swordsman']],
  ['Rouge', 'A fortune-teller whose presentation leans into fire and mystery.', 'Rouge enters the contest with poise, spectacle, and an enigmatic past.', ['zoner', 'fire trickster']],
  ['Ayame', 'A nimble performer with a fast, evasive identity.', 'Ayame balances her stagecraft with the agility needed for the stone hunt.', ['speedster', 'evasive striker']],
  ['Gunrock', 'A huge miner whose identity emphasizes raw force.', 'Gunrock’s working-life roots and massive frame make him an imposing contender.', ['heavy hitter', 'grappler']],
  ['Galuda', 'A proud warrior whose identity emphasizes strength and duty.', 'Galuda carries a protective spirit into every arena.', ['tank', 'power striker']],
  ['Jack', 'A mysterious, bladed combatant with an unsettling silhouette.', 'Jack’s motives and identity remain deliberately obscure.', ['mixup menace', 'blade specialist']],
  ['Accel', 'A cool-headed gunslinger introduced in Power Stone 2.', 'Accel brings a frontier-inspired style to the expanded roster.', ['ranged nightmare', 'gunslinger']],
  ['Julia', 'An adventurous newcomer with an elegant, spirited presence.', 'Julia joins the treasure chase on her own terms.', ['balanced fighter', 'technical']],
  ['Pete', 'A compact mechanical fighter with playful movement.', 'Pete adds a bright retro-future personality to the roster.', ['trickster', 'small hitbox']],
  ['Gourmand', 'A chef-themed competitor with an eccentric fighting identity.', 'Gourmand turns culinary flair into arena spectacle.', ['unorthodox', 'item abuser']],
  ['Pride', 'A composed swordsman presented as an unlockable fighter.', 'Pride’s connection to Falcon gives his appearance extra narrative weight.', ['counter specialist', 'swordsman']],
  ['Mel', 'A poised adventurer presented as an unlockable fighter.', 'Mel’s role ties the wider adventure and item systems together.', ['support-style', 'item synergy']],
].map(([name, tagline, playstyle, keywords]) => ({
  name,
  tagline,
  playstyle,
  keywords,
...
const expectedPspExclusiveCopy = [
  {
    ...
    playstyle: 'Kraken appears as one of two fighters exclusive to Power Stone Collection on PSP, expanding the roster beyond the original Dreamcast and arcade lineup.',
    keywords: ['grappler', 'heavyweight'],
    moves: ['Core attacks — notation to verify', 'Power Stone transformation — inputs to verify', 'Mobility / item play — inputs to verify'],
  },
  {
    name: 'Valgas',
    tagline: 'A commanding unlockable fighter added in the PSP compilation.',
    playstyle: 'General Valgas joins Kraken as one of two fighters exclusive to Power Stone Collection on PSP, not part of the original Dreamcast and arcade roster.',
    keywords: ['tank', 'command grabs'],
    moves: ['Core attacks — notation to verify', 'Power Stone transformation — inputs to verify', 'Mobility / item play — inputs to verify'],
  },
]
...
const expectedLevelCopy = [
  ...
  { name: 'Dark Castle Area', description: 'A bright multi-tier battleground represented with replaceable study art.', media: '/media/levels/levels-gallery/dark-castle-area/stage1-1-compressed.jpg', slides: ['/media/levels/levels-gallery/dark-castle-area/stage1-1-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage1-2-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage1-3-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage1-4-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage2-1-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage2-2-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage2-3-compressed.jpg', '/media/levels/levels-gallery/dark-castle-area/stage3-1-compressed.jpg'] },
...
describe('world data', () => {
  ...
  it('exactly preserves every displayed field from 1eca5f7', () => {
    ...
    expect(dreamcastCharacters.map(({ name, tagline, playstyle, keywords, moves }) => ({ name, tagline, playstyle, keywords, moves }))).toEqual(expectedCharacterCopy)
    expect(pspExclusiveCharacters.map(({ name, tagline, playstyle, keywords, moves }) => ({ name, tagline, playstyle, keywords, moves }))).toEqual(expectedPspExclusiveCopy)
